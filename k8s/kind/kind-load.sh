...
docker pull tejadocker2015/new-api-gateway:latest
docker pull tejadocker2015/new-product-service:latest
docker pull tejadocker2015/new-order-service:latest
docker pull tejadocker2015/new-inventory-service:latest
docker pull tejadocker2015/new-notification-service:latest
...
kind load docker-image -n microservices tejadocker2015/new-api-gateway:latest
kind load docker-image -n microservices tejadocker2015/new-product-service:latest
kind load docker-image -n microservices tejadocker2015/new-order-service:latest
kind load docker-image -n microservices tejadocker2015/new-inventory-service:latest
kind load docker-image -n microservices tejadocker2015/new-notification-service:latest
